<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p>
            <b class="pr-2">Email</b> keanu.sida@gmail.com
        </p>
        <p>
            ...
            <a 
                ...
                target="_blank" 
                href="https://github.com/keanu-sida/">keanu-sida
                <sup>
                    <span class="text-xd scale-75 pl-0.5">
                        <i 
        ...
        <p>
            ...
            <a 
                class="text-violet-400" 
                target="_blank" 
                href="https://www.linkedin.com/in/keanu-sida">keanu-sida
                <sup>
                    <span class="text-xd scale-75 pl-0.5">
                        <i 
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
