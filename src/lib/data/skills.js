/** Skills as evidence — each item is attached to shipped work. */

export const skillEvidence = [
	{ name: 'Three.js / Pixi.js', evidence: 'PathTree helix home and orchard map' },
	{ name: 'SvelteKit', evidence: 'This site — static adapter, shared content modules' },
	{ name: 'React + TypeScript', evidence: 'Pipeline, local-only job tracker' },
